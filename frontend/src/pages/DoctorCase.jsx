...
export default function DoctorCase() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 to-blue-950 flex flex-col max-w-lg mx-auto">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 pb-36">
        ...
        {consultation?.transcript && (
          <div className="bg-white/5 border border-white/10 rounded-2xl p-4">
            ...
            {showTranscript && (
              <pre className="mt-3 text-xs text-slate-400 whitespace-pre-wrap font-mono bg-black/30 rounded-xl p-3 max-h-52 overflow-y-auto">
                {consultation.transcript}
              </pre>
            )}
          </div>
          ...
          <>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-4 space-y-3">
              ...
              <div className="flex gap-2 pt-1">
                <input
                  ...
                  className="flex-1 bg-white/10 border border-white/15 rounded-xl px-3 py-2.5 text-white text-xs placeholder-slate-500 focus:outline-none focus:border-blue-500"
                />
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-4 space-y-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-white/10 border border-white/15 rounded-xl px-3 py-2.5 text-white text-sm placeholder-slate-500 focus:outline-none focus:border-blue-500 resize-none"
              />
            </div>
          </>
        )}
      ...
      {consultation?.status === 'pending' && (
        <div className="fixed bottom-0 left-0 right-0 max-w-lg mx-auto px-4 pb-8 pt-4 bg-gradient-to-t from-slate-950 via-slate-950/95 to-transparent">
